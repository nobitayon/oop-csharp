...
class Program
{
    ...
    private static void SeedData(IList<IEmployee> employees)
    {
        ...
        electrician.JoinDate = new DateTime(2013,5,7);
...
public abstract class Employee:IEmployee
{
    ...
    {
        return $"Id: {Id} {Environment.NewLine}JobTitle: {JobTitle}{Environment.NewLine}FirstName: {FirstName}{Environment.NewLine}LastName: {LastName}{Environment.NewLine}Annual Salary: {AnnualSalary}";
    }
