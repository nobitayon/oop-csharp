...
public class AppOfficeControl:BaseOfficeControl
{
    ...
    private void LogLightingStatus()
    {
        ...
        foreach(Office office in base.Offices)
        {
            ...
            Console.WriteLine($"Remote Control Device: Lights for office:{office.OfficeId} is switched {status}");
        }
        Console.WriteLine();
    }
    ...
    private void LogSecurityStatus()
    {
        ...
        foreach(Office office in base.Offices)
        {
            ...
            Console.WriteLine($"Remote Control Device: Security for office:{office.OfficeId} is {status}");
        };
